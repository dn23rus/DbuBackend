...
class Bootstrap
{
    ...
    public static function init()
    {
        if (is_readable(__DIR__ . DIRECTORY_SEPARATOR . 'TestConfig.php')) {
            $testConfig = include __DIR__ . DIRECTORY_SEPARATOR . 'TestConfig.php';
        } else {
            $testConfig = include __DIR__ . DIRECTORY_SEPARATOR . 'TestConfig.php.dist';
        }
    ...
    public static function initAutoloader()
    {
        ...
        if (is_readable($vendorPath . DIRECTORY_SEPARATOR . 'autoload.php')) {
            $loader = include $vendorPath . DIRECTORY_SEPARATOR . 'autoload.php';
        } else {
